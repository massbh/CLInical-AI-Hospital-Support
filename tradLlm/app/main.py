...
from app.report_structuring import REPORT_SECTION_TITLES, structure_report
...
class ReportStructureRequest(BaseModel):
    notes: list[str] = Field(
        ...
        description="Validated appointment notes generated by medBrain.",
    )
    suggestions: list[str] = Field(
        default_factory=list,
        description="Validated appointment suggestions generated by medBrain.",
    )
...
@app.post(
    "/report/structure",
    response_model=ReportStructureResponse,
    summary="Structure appointment notes and suggestions into report sections",
)
async def report_structure(
    body: ReportStructureRequest,
) -> ReportStructureResponse:
    sections = await structure_report(body.notes, body.suggestions)
    return ReportStructureResponse(
        sections=[
            ReportSection(title=title, content=sections.get(title, ""))
